...
def main(config: OmegaConf):
    ...
    # Embodiment transfer helper: write layout.json + template.pt and exit (see
    # gear_sonic/utils/embodiment/layout_dump.py and scripts/r1/surgery_g1_to_r1_checkpoint.py).
    if config.get("dump_layout_dir", None) is not None:
        from gear_sonic.utils.embodiment.layout_dump import dump_layout_and_template
